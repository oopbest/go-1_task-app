...
type NotificationServiceClient interface {
	...
	GetNotificationStats(ctx context.Context, in *StatsRequest, opts ...grpc.CallOption) (*StatsResponse, error)
}
...
func (c *notificationServiceClient) GetNotificationStats(ctx context.Context, in *StatsRequest, opts ...grpc.CallOption) (*StatsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(StatsResponse)
	err := c.cc.Invoke(ctx, NotificationService_GetNotificationStats_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NotificationServiceServer interface {
	...
	GetNotificationStats(context.Context, *StatsRequest) (*StatsResponse, error)
...
func (UnimplementedNotificationServiceServer) GetNotificationStats(context.Context, *StatsRequest) (*StatsResponse, error) {
...
func _NotificationService_GetNotificationStats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NotificationServiceServer).GetNotificationStats(ctx, req.(*StatsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
